      ...
      <Box2>
        ...
        >
          ...
          <ul style={{ listStyle: "none"}}>
            <li>
              <a href="https://www.instagram.com/gamzeeseyit/" style={{color:"black"}}>
                <InstagramIcon />
              </a>
            </li>
            <li>
              <a href="https://github.com/gmzsyt" style={{color:"black"}}>
                <GitHubIcon />
              </a>
            </li>
            <li>
              <a href="https://www.linkedin.com/in/gamzenur-seyit-174618211/" style={{color:"black"}}>
                <LinkedInIcon />
              </a>
            </li>
          </ul>
